...
namespace Ciribob.IL2.SimpleRadio.Standalone.Client.Settings
{
    ...
    public class GlobalSettingsStore
    {
        ...
        private readonly Dictionary<string, string> defaultGlobalSettings = new Dictionary<string, string>()
        {
            ...
            {GlobalSettingsKeys.ClientListOpacity.ToString(), "1.0"},
            {GlobalSettingsKeys.PilotRosterOpacity.ToString(), "1.0"},
            {GlobalSettingsKeys.WeatheringEnabled.ToString(), "true"},
            {GlobalSettingsKeys.WeatheringOpacity.ToString(), "0.5"},
